...
`hmstimer` is a dependency-free R package to 
...
If the timer is running then the system time (in seconds since 1970-01-01 UTC) is stored as the start attribute.
Otherwise the start attribute is NULL.
